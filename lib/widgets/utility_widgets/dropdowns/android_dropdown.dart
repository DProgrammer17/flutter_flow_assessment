            ...
            children: [
                      ...
                      ValueListenableBuilder(
                        ...
                        builder: (context, String? value, child) {
                          ...
                          return Text(
                            ...
                            style:
                                widget.hintStyle ??
                                AppTextStyles.body1RegularPoppins(context),
                    ...
                    ValueListenableBuilder(
                      ...
                      builder: (context, String? value, child) {
                        return Text(
                          ...
                          style: value == null
                              ? widget.style ??
                              AppTextStyles.h3Poppins(context).copyWith(
                                fontWeight: FontWeight.w400,
                                color:widget.textColor ?? AppColors.textGreyLight,
                              )
                              : widget.style ??
                              AppTextStyles.h3Poppins(context).copyWith(
                                fontWeight: FontWeight.w400,
                                color:widget.dropDownTextColor ?? AppColors.textGreyLight,
                              ),
                          maxLines: 1,
              ...
              RotationTransition(
                ...
                child: Icon(
                  ...
                  size: 24.ar,
                  color: widget.dropIconColor ?? AppColors.textGreyLight,
                ),
              ),
            ],
          ),
                              ...
                              child: DecoratedBox(
                                ...
                                child: Padding(
                                  ...
                                  child:    ValueListenableBuilder(
                                      ...
                                      builder: (context, String? value, child) {
                                      return Container(
                                        padding: EdgeInsets.symmetric(horizontal: 8.aw, vertical: 10.ah),
                                        decoration: BoxDecoration(
                                          color: value == e.value ? AppColors.highlightOrange : Colors.transparent,
                                        ...
                                        child: Row(
                                          ...
                                          children: [
                                            Text(
                                              e.value,
                                              style: AppTextStyles.h3Poppins(context).copyWith(
                                                fontWeight: FontWeight.w400,
